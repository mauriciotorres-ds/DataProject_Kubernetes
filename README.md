...
**Key observation:** BlockDAG (BDAG) dropped ~70% over the tracking window, completely dominating the volatility and Sharpe ratio panels. The five remaining coins (BTC, ETH, XRP, SOL, TAO) appeared nearly stable by comparison — a textbook illustration of how one high-variance outlier skews risk metrics.
